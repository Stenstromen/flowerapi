...
const flowerdb = new sqlite3.Database(sqlDbFile, (error) => {
  ...
  flowerdb.run(statement, (error) => {
    ...
    flowerdb.run(insert, [
      "TLieutenant Heart",
      "Ida's favorite flower",
      "Unknown",
      "HOSTNAME/assets/img/pic.jpg",
    ]);
    flowerdb.run(insert, [
      "Tulips",
      "Pretty wild tulips",
      "Filip",
      "HOSTNAME/assets/img/tulips.jpg",
    ]);
    flowerdb.run(insert, [
      "Tulips 2",
      "Pretty tulips",
      "Filip",
      "HOSTNAME/assets/img/tulips2.jpg",
    ]);
    flowerdb.run(insert, [
      "Thimble FLower",
      "Thimble Flower from a store",
      "Filip",
      "HOSTNAME/assets/img/thimbleflower.jpg",
    ]);
    flowerdb.run(insert, [
      "Japanese Maple",
      "Japanese Maple from store",
      "Filip",
      "HOSTNAME/assets/img/japanesemaple.jpg",
    ]);
    flowerdb.run(insert, [
      "Apple Tree Flower",
      "Apple Tree Flower",
      "Filip",
      "HOSTNAME/assets/img/appletree.jpg",
    ]);
    flowerdb.run(insert, [
      "Unknown",
      "Unknown Bushflower",
      "Filip",
      "HOSTNAME/assets/img/unknown.jpg",
    ]);
  });
});
